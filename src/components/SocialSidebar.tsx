...
export const SocialSidebar = () => {
  return (
    <div className="fixed left-6 top-1/2 -translate-y-1/2 z-50 hidden xl:flex flex-col gap-6 items-center">
      <Link href="https://github.com/9xxxxxx/9xxxxxx.github.io" target="_blank" className="p-3 rounded-full bg-white dark:bg-black border border-neutral-200 dark:border-white/[0.2] shadow-sm hover:scale-110 transition-transform duration-200 group">
